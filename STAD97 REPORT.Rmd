...
```{r}
sumofcomofoeachpt=apply(a,1,sum)
...
-both male and female patients in age group 80+ have the lowest admit and discharged Regimen related distress score
-spread issue??? skew to the right ...
