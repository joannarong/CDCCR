...
dataframe=suppressWarnings(Readdata())
head(dataframe)
```
...
```{r,w}
avgchronic=subset(dataframe, select=c("Other.Chronic.","Neuropathy.1","Retinopathy","Blindness","Cardiovascular.disease.Chronic.","Wounds..non.healing.",
                             "Amputation","Skin.conditions..cutaneous.manifestations.","Lipohypertrophy","Hypoglycemia.unawareness",
                             "Diabetic.myonecrosis","Foot.problems..Charcot.s.","Stiff.man.s.syndrome","Hearing.impairment","Fractures","Nephropathy"))

avgchronic %>% gather(col,v,Other.Chronic.:Nephropathy) %>% table()
```
...
```{r}
sumofchronicfoeachpt=apply(avgchronic,1,sum) 
